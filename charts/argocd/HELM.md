...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argocd(argo-cd) | 8.0.13 |
...
| argocd.configs.cm."dex.config" | string | `"connectors:\n  - config:\n      issuer: https://accounts.google.com\n      clientID: 45405492545-hmp5maiel88eebgk1d7h3vfa2siboak4.apps.googleusercontent.com\n      clientSecret: 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\n    type: oidc\n    id: google\n    name: Google\n"` |  |
...
| argocd.configs.secret.argocdServerAdminPassword | string | `"$2a$10$xQJJ7NlHci89bbATu9XLDu19KMnMAQkQfp6jZ/rC3IkBTNcRsVwwa"` | Bcrypt hashed admin password # Argo expects the password in the secret to be bcrypt hashed. You can create this hash with # `htpasswd -nbBC 10 "" $ARGO_PWD | tr -d ':\n' | sed 's/$2y/$2a/'` |
...
| argocd.redis.exporter.image.tag | string | `"v1.73.0"` | Tag to use for the redis-exporter |
