...
```
docker run --rm -it -v $(pwd):/apps -v pluto:/pluto alpine/helm:3.17 template openlane-gcp-gke-cluster . -f tests/pluto/values.yaml --output-dir /pluto
