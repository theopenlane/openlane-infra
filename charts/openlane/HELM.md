...
| openlane.image.tag | string | `"v0.48.4"` |  |
...
| openlane.coreConfiguration.server.tls | object | `{"autocert":false,"certfile":"server.crt","certkey":"server.key","enabled":false}` | TLS contains the tls configuration settings |
...
| openlane.coreConfiguration.server.enablegraphsubscriptions | bool | `false` | EnableGraphSubscriptions enables graphql subscriptions to the server using websockets or sse |
...
| openlane.coreConfiguration.server.trustcenterpreviewzoneid | string | `""` | TrustCenterPreviewZoneID is the cloudflare zone id for the trust center preview domain |
| openlane.coreConfiguration.entconfig | object | `{"billing":{"bypassemaildomains":[],"requirepaymentmethod":false},"emailvalidation":{"allowedemailtypes":{"disposable":false,"free":false,"role":false},"enableautoupdatedisposable":true,"enabled":false,"enablegravatarcheck":true,"enablesmtpcheck":false},"entitytypes":[],"maxpoolsize":100,"maxschemaimportsize":262144,"modules":{"enabled":true,"usesandbox":false},"notifications":{"consoleurl":"http://localhost:3001"},"summarizer":{"llm":{"anthropic":{"baseurl":"","betaheader":"","legacytextcompletion":false},"cloudflare":{"accountid":"","serverurl":""},"openai":{"organizationid":"","url":""},"provider":"none"},"maximumsentences":10,"type":"lexrank"},"windmill":{"baseurl":"https://app.windmill.dev","defaulttimeout":"30s","enabled":false,"onfailurescript":"","onsuccessscript":"","timezone":"UTC","workspace":""}}` | EntConfig contains the ent configuration used by the ent middleware |
...
| openlane.coreConfiguration.entconfig.emailvalidation | object | `{"allowedemailtypes":{"disposable":false,"free":false,"role":false},"enableautoupdatedisposable":true,"enabled":false,"enablegravatarcheck":true,"enablesmtpcheck":false}` | EmailValidation contains configuration for email validation |
...
| openlane.coreConfiguration.authz | object | `{"createnewmodel":false,"credentials":{"audience":"","clientid":"","issuer":"","scopes":""},"enabled":true,"hosturl":"https://authz.theopenlane.io","maxbatchwritesize":100,"modelfile":"fga/model/model.fga","modelid":"","storeid":"","storename":"openlane"}` | Authz contains the authorization settings for fine grained access control |
...
| openlane.coreConfiguration.authz.maxbatchwritesize | int | `100` | maximum number of writes per batch in a transaction |
...
| openlane.coreConfiguration.email | object | `{"companyaddress":"","companyname":"","corporation":"","fromemail":"","logourl":"","supportemail":"","templatespath":"","urls":{"docs":"","invite":"","product":"","questionnaire":"","reset":"","root":"","verify":"","verifybilling":"","verifysubscriber":""},"year":0}` | Email contains email sending configuration for the server |
...
| openlane.coreConfiguration.objectstorage | object | `{"devmode":false,"enabled":true,"keys":["uploadFile"],"maxmemorymb":0,"maxsizemb":0,"providers":{"database":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""},"disk":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""},"r2":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""},"s3":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""}}}` | ObjectStorage contains the configuration for the object storage backend |
...
| openlane.coreConfiguration.objectstorage.devmode | bool | `false` | DevMode automatically configures a local disk storage provider (and ensures directories exist) and ignores other provider configs |
| openlane.coreConfiguration.objectstorage.providers | object | `{"database":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""},"disk":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""},"r2":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""},"s3":{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""}}` | Providers contains configuration for each storage provider |
...
| openlane.coreConfiguration.objectstorage.providers.r2 | object | `{"baseurl":"http://localhost:17608/v1/files","bucket":"","credentials":null,"enabled":false,"endpoint":"","ensureavailable":false,"proxypresignenabled":false,"region":""}` | R2 provider configuration |
| openlane.coreConfiguration.objectstorage.providers.r2.enabled | bool | `false` | Enabled indicates if this provider is enabled |
| openlane.coreConfiguration.objectstorage.providers.r2.ensureavailable | bool | `false` | EnsureAvailable enforces provider availability before completing server startup |
| openlane.coreConfiguration.objectstorage.providers.r2.region | string | `""` | Region for cloud providers |
| openlane.coreConfiguration.objectstorage.providers.r2.bucket | string | `""` | Bucket name for cloud providers |
| openlane.coreConfiguration.objectstorage.providers.r2.endpoint | string | `""` | Endpoint for custom endpoints |
| openlane.coreConfiguration.objectstorage.providers.r2.proxypresignenabled | bool | `false` | ProxyPresignEnabled toggles proxy-signed download URL generation |
| openlane.coreConfiguration.objectstorage.providers.r2.baseurl | string | `"http://localhost:17608/v1/files"` | BaseURL is the prefix for proxy download URLs (e.g., http://localhost:17608/v1/files). |
| openlane.coreConfiguration.objectstorage.providers.r2.credentials | string | `nil` | Credentials contains the credentials for accessing the provider |
...
| openlane.coreConfiguration.subscription | object | `{"enabled":false,"stripebillingportalsuccessurl":"https://console.theopenlane.io/organization-settings/billing","stripecancellationreturnurl":"https://console.theopenlane.io/organization-settings/billing","stripewebhookapiversion":"2025_10_29_CLOVER","stripewebhookdiscardapiversion":"","stripewebhookevents":[],"stripewebhookurl":"https://api.theopenlane.io/stripe/webhook"}` | Entitlements contains the configuration for the entitlements service |
...
| openlane.coreConfiguration.subscription.stripewebhookapiversion | string | `"2025_10_29_CLOVER"` | StripeWebhookAPIVersion is the Stripe API version currently accepted by the webhook handler |
...
| openlane.coreConfiguration.integrationoauthprovider | object | `{"enabled":false,"successredirecturl":""}` | IntegrationOauthProvider contains the OAuth provider configuration for integrations (separate from auth.providers) |
| openlane.coreConfiguration.integrationoauthprovider.enabled | bool | `false` | Enabled toggles initialization of the integration provider registry. |
...
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accesskeyid | object | `{"enabled":true,"remoteKey":"core-objectstorage-providers-r2-credentials-accesskeyid","secretKey":"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_ACCESSKEYID"}` | core-objectstorage-providers-r2-credentials-accesskeyid secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accesskeyid.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accesskeyid.secretKey | string | `"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_ACCESSKEYID"` | Environment variable key for objectstorage.providers.r2.credentials.accesskeyid |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accesskeyid.remoteKey | string | `"core-objectstorage-providers-r2-credentials-accesskeyid"` | Remote key in GCP Secret Manager |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-secretaccesskey | object | `{"enabled":true,"remoteKey":"core-objectstorage-providers-r2-credentials-secretaccesskey","secretKey":"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_SECRETACCESSKEY"}` | core-objectstorage-providers-r2-credentials-secretaccesskey secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-secretaccesskey.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-secretaccesskey.secretKey | string | `"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_SECRETACCESSKEY"` | Environment variable key for objectstorage.providers.r2.credentials.secretaccesskey |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-secretaccesskey.remoteKey | string | `"core-objectstorage-providers-r2-credentials-secretaccesskey"` | Remote key in GCP Secret Manager |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-projectid | object | `{"enabled":true,"remoteKey":"core-objectstorage-providers-r2-credentials-projectid","secretKey":"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_PROJECTID"}` | core-objectstorage-providers-r2-credentials-projectid secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-projectid.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-projectid.secretKey | string | `"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_PROJECTID"` | Environment variable key for objectstorage.providers.r2.credentials.projectid |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-projectid.remoteKey | string | `"core-objectstorage-providers-r2-credentials-projectid"` | Remote key in GCP Secret Manager |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accountid | object | `{"enabled":true,"remoteKey":"core-objectstorage-providers-r2-credentials-accountid","secretKey":"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_ACCOUNTID"}` | core-objectstorage-providers-r2-credentials-accountid secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accountid.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accountid.secretKey | string | `"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_ACCOUNTID"` | Environment variable key for objectstorage.providers.r2.credentials.accountid |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-accountid.remoteKey | string | `"core-objectstorage-providers-r2-credentials-accountid"` | Remote key in GCP Secret Manager |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-apitoken | object | `{"enabled":true,"remoteKey":"core-objectstorage-providers-r2-credentials-apitoken","secretKey":"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_APITOKEN"}` | core-objectstorage-providers-r2-credentials-apitoken secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-apitoken.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-apitoken.secretKey | string | `"CORE_OBJECTSTORAGE_PROVIDERS_R2_CREDENTIALS_APITOKEN"` | Environment variable key for objectstorage.providers.r2.credentials.apitoken |
| openlane.coreConfiguration.externalSecrets.secrets.core-objectstorage-providers-r2-credentials-apitoken.remoteKey | string | `"core-objectstorage-providers-r2-credentials-apitoken"` | Remote key in GCP Secret Manager |
