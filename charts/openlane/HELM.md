...
| openlane.image.tag | string | `"v0.42.6"` |  |
...
| openlane.coreConfiguration.ratelimit | object | `{"denyMessage":"Too many requests","denyStatus":429,"dryRun":true,"enabled":false,"forwardedIndexFromBehind":0,"headers":["True-Client-IP"],"includeMethod":false,"includePath":false,"keyPrefix":"","options":[],"sendRetryAfterHeader":true}` | Ratelimit contains the configuration for the rate limiter |
| openlane.coreConfiguration.ratelimit.options | list | `[]` | Options enables configuring multiple concurrent rate windows that must all pass. |
