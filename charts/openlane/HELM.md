...
| openlane.image.tag | string | `"v0.43.2"` |  |
...
| openlane.coreConfiguration.subscription | object | `{"enabled":false,"stripeBillingPortalSuccessURL":"https://console.openlane.com/organization-settings/billing","stripeCancellationReturnURL":"https://console.theopenlane.io/organization-settings/billing","stripeWebhookAPIVersion":"2024-11-20.acacia","stripeWebhookDiscardAPIVersion":"2024-10-28.acacia","stripeWebhookEvents":[],"stripeWebhookURL":"https://api.openlane.com/v1/stripe/webhook"}` | Entitlements contains the configuration for the entitlements service |
...
| openlane.coreConfiguration.subscription.stripeWebhookAPIVersion | string | `"2024-11-20.acacia"` | StripeWebhookAPIVersion is the Stripe API version currently accepted by the webhook handler |
| openlane.coreConfiguration.subscription.stripeWebhookDiscardAPIVersion | string | `"2024-10-28.acacia"` | StripeWebhookDiscardAPIVersion is the Stripe API version to discard during migration |
...
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-10-28-acacia | object | `{"enabled":true,"remoteKey":"core-subscription-stripewebhooksecrets-2024-10-28-acacia","secretKey":"CORE_SUBSCRIPTION_STRIPEWEBHOOKSECRETS_2024_10_28_ACACIA"}` | core-subscription-stripewebhooksecrets-2024-10-28-acacia secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-10-28-acacia.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-10-28-acacia.secretKey | string | `"CORE_SUBSCRIPTION_STRIPEWEBHOOKSECRETS_2024_10_28_ACACIA"` | Environment variable key for subscription.stripeWebhookSecrets.2024-10-28.acacia |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-10-28-acacia.remoteKey | string | `"core-subscription-stripewebhooksecrets-2024-10-28-acacia"` | Remote key in GCP Secret Manager |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-11-20-acacia | object | `{"enabled":true,"remoteKey":"core-subscription-stripewebhooksecrets-2024-11-20-acacia","secretKey":"CORE_SUBSCRIPTION_STRIPEWEBHOOKSECRETS_2024_11_20_ACACIA"}` | core-subscription-stripewebhooksecrets-2024-11-20-acacia secret configuration |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-11-20-acacia.enabled | bool | `true` | Enable this external secret |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-11-20-acacia.secretKey | string | `"CORE_SUBSCRIPTION_STRIPEWEBHOOKSECRETS_2024_11_20_ACACIA"` | Environment variable key for subscription.stripeWebhookSecrets.2024-11-20.acacia |
| openlane.coreConfiguration.externalSecrets.secrets.core-subscription-stripewebhooksecrets-2024-11-20-acacia.remoteKey | string | `"core-subscription-stripewebhooksecrets-2024-11-20-acacia"` | Remote key in GCP Secret Manager |
