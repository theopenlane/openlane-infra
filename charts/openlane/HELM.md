...
| openlane.image.tag | string | `"v0.46.7"` |  |
...
| openlane.coreConfiguration.integrationoauthprovider | object | `{"providerspecpath":"internal/integrations/config/providers","successredirecturl":""}` | IntegrationOauthProvider contains the OAuth provider configuration for integrations (separate from auth.providers) |
...
| openlane.coreConfiguration.integrationoauthprovider.providerspecpath | string | `"internal/integrations/config/providers"` | ProviderSpecPath is the path to the declarative provider spec configuration file. |
