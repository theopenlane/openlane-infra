...
| openlane.image.tag | string | `"v0.35.3"` |  |
...
| openlane.coreConfiguration.entConfig.emailValidation | object | `{"allowedEmailTypes":{"disposable":false,"free":false,"role":false},"enableAutoUpdateDisposable":true,"enabled":false}` | EmailValidation contains configuration for email validation |
