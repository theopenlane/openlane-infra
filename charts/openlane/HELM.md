...
| openlane.coreConfiguration.server.tls | object | `{"autoCert":false,"certFile":"server.crt","certKey":"server.key","config":"<nil>","enabled":false}` | TLS contains the tls configuration settings |
...
| openlane.coreConfiguration.entConfig | object | `{"entityTypes":[],"maxPoolSize":100,"summarizer":{"llm":{"anthropic":{"baseURL":"","betaHeader":"","legacyTextCompletion":false},"cloudflare":{"accountID":"","serverURL":""},"gemini":{"credentialsPath":"","maxTokens":0},"huggingFace":{"url":""},"mistral":{"url":""},"ollama":{"model":"","url":""},"openai":{"organizationID":"","url":""},"provider":null},"maximumSentences":60,"type":"lexrank"}}` | EntConfig contains the ent configuration used by the ent middleware |
...
| openlane.coreConfiguration.entConfig.summarizer | object | `{"llm":{"anthropic":{"baseURL":"","betaHeader":"","legacyTextCompletion":false},"cloudflare":{"accountID":"","serverURL":""},"gemini":{"credentialsPath":"","maxTokens":0},"huggingFace":{"url":""},"mistral":{"url":""},"ollama":{"model":"","url":""},"openai":{"organizationID":"","url":""},"provider":null},"maximumSentences":60,"type":"lexrank"}` | Summarizer contains configuration for text summarization |
| openlane.coreConfiguration.entConfig.summarizer.type | string | `"lexrank"` | Type specifies the summarization algorithm to use |
| openlane.coreConfiguration.entConfig.summarizer.llm | object | `{"anthropic":{"baseURL":"","betaHeader":"","legacyTextCompletion":false},"cloudflare":{"accountID":"","serverURL":""},"gemini":{"credentialsPath":"","maxTokens":0},"huggingFace":{"url":""},"mistral":{"url":""},"ollama":{"model":"","url":""},"openai":{"organizationID":"","url":""},"provider":null}` | LLM contains configuration for large language model based summarization |
...
| openlane.coreConfiguration.entConfig.summarizer.llm.mistral | object | `{"url":""}` | Mistral contains configuration for Mistral's API |
| openlane.coreConfiguration.entConfig.summarizer.llm.mistral.url | string | `""` | URL specifies the API endpoint |
| openlane.coreConfiguration.entConfig.summarizer.llm.gemini | object | `{"credentialsPath":"","maxTokens":0}` | Gemini contains configuration for Google's Gemini API |
| openlane.coreConfiguration.entConfig.summarizer.llm.gemini.credentialsPath | string | `""` | CredentialsPath is the path to Google Cloud credentials file |
| openlane.coreConfiguration.entConfig.summarizer.llm.gemini.maxTokens | int | `0` | MaxTokens specifies the maximum tokens for response |
| openlane.coreConfiguration.entConfig.summarizer.llm.huggingFace | object | `{"url":""}` | HuggingFace contains configuration for HuggingFace's API |
| openlane.coreConfiguration.entConfig.summarizer.llm.huggingFace.url | string | `""` | URL specifies the API endpoint |
| openlane.coreConfiguration.entConfig.summarizer.llm.ollama | object | `{"model":"","url":""}` | Ollama contains configuration for Ollama's API |
| openlane.coreConfiguration.entConfig.summarizer.llm.ollama.model | string | `""` | Model specifies the model to use |
| openlane.coreConfiguration.entConfig.summarizer.llm.ollama.url | string | `""` | URL specifies the API endpoint |
...
| openlane.coreConfiguration.auth | object | `{"enabled":true,"providers":{"github":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/github/callback","scopes":[]},"google":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/google/callback","scopes":[]},"redirectUrl":"http://localhost:3001/api/auth/callback/theopenlane","webauthn":{"debug":false,"displayName":"","enabled":true,"enforceTimeout":true,"maxDevices":10,"relyingPartyId":"localhost","requestOrigins":["http://localhost:3001"],"timeout":"1m0s"}},"supportedProviders":[],"token":{"accessDuration":"1h0m0s","audience":"https://theopenlane.io","generateKeys":true,"issuer":"https://auth.theopenlane.io","jwksEndpoint":"https://api.theopenlane.io/.well-known/jwks.json","keys":{},"kid":"","refreshAudience":"","refreshDuration":"2h0m0s","refreshOverlap":"-15m0s"}}` | Auth contains the authentication token settings and provider(s) |
| openlane.coreConfiguration.auth.enabled | bool | `true` | Enabled authentication on the server, not recommended to disable |
| openlane.coreConfiguration.auth.token | object | `{"accessDuration":"1h0m0s","audience":"https://theopenlane.io","generateKeys":true,"issuer":"https://auth.theopenlane.io","jwksEndpoint":"https://api.theopenlane.io/.well-known/jwks.json","keys":{},"kid":"","refreshAudience":"","refreshDuration":"2h0m0s","refreshOverlap":"-15m0s"}` | Token contains the token config settings for the issued tokens |
...
| openlane.coreConfiguration.auth.providers | object | `{"github":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/github/callback","scopes":[]},"google":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/google/callback","scopes":[]},"redirectUrl":"http://localhost:3001/api/auth/callback/theopenlane","webauthn":{"debug":false,"displayName":"","enabled":true,"enforceTimeout":true,"maxDevices":10,"relyingPartyId":"localhost","requestOrigins":["http://localhost:3001"],"timeout":"1m0s"}}` | Providers contains supported oauth2 providers configuration |
...
| openlane.coreConfiguration.auth.providers.github | object | `{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/github/callback","scopes":[]}` | Github contains the configuration settings for the Github Oauth Provider |
| openlane.coreConfiguration.auth.providers.google | object | `{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/google/callback","scopes":[]}` | Google contains the configuration settings for the Google Oauth Provider |
| openlane.coreConfiguration.auth.providers.webauthn | object | `{"debug":false,"displayName":"","enabled":true,"enforceTimeout":true,"maxDevices":10,"relyingPartyId":"localhost","requestOrigins":["http://localhost:3001"],"timeout":"1m0s"}` | Webauthn contains the configuration settings for the Webauthn Oauth Provider |
...
| openlane.coreConfiguration.authz.credentials | object | `{"apiToken":"","audience":"","clientId":"","clientSecret":"","issuer":"","scopes":""}` | credentials for the openFGA client |
| openlane.coreConfiguration.authz.credentials.apiToken | string | `""` | api token for the openFGA client |
| openlane.coreConfiguration.authz.credentials.clientId | string | `""` | client id for the openFGA client |
| openlane.coreConfiguration.authz.credentials.clientSecret | string | `""` | client secret for the openFGA client |
...
| openlane.coreConfiguration.jobQueue | object | `{"connectionURI":"postgres://postgres:password@0.0.0.0:5432/jobs?sslmode=disable","riverConf":null,"runMigrations":false}` | JobQueue contains the configuration for the job queue (river) client |
...
| openlane.coreConfiguration.sessions | object | `{"domain":"","encryptionKey":"encryptionsecret","httpOnly":true,"maxAge":3600,"sameSite":"Strict","secure":true,"signingKey":"my-signing-secret"}` | Sessions config for user sessions and cookies |
| openlane.coreConfiguration.totp | object | `{"codeLength":6,"enabled":true,"issuer":"","recoveryCodeCount":16,"recoveryCodeLength":8,"redis":true,"secret":""}` | TOTP contains the configuration for the TOTP provider |
...
| openlane.coreConfiguration.subscription | object | `{"enabled":false,"personalOrgSubscriptionPriceID":"price_1QycPyBvxky1R7Svz0gOWnNh","publicStripeKey":"","stripeBillingPortalSuccessURL":"https://console.openlane.com/billing","stripeCancellationReturnURL":"https://console.theopenlane.io/organization-settings/billing/subscription_canceled","stripeWebhookEvents":[],"stripeWebhookURL":"https://api.openlane.com/v1/stripe/webhook","trialSubscriptionPriceID":"price_1QKLyeBvxky1R7SvaZYGWyQb"}` | Entitlements contains the configuration for the entitlements service |
...
| refreshInterval | string | `"10m0s"` | RefreshInterval determines how often to reload the config |
| server | object | `{"cacheControl":{"enabled":true,"etagHeaders":[],"noCacheHeaders":{}},"complexityLimit":100,"cors":{"allowOrigins":[],"cookieInsecure":false,"enabled":true,"prefixes":{}},"csrfProtection":{"cookie":"ol.csrf-token","cookieDomain":"","cookieHttpOnly":false,"cookiePath":"/","enabled":false,"header":"X-CSRF-Token","sameSite":"Lax","secure":true},"defaultTrustCenterDomain":"","dev":false,"enableGraphExtensions":true,"graphPool":{"maxWorkers":100},"idleTimeout":"30s","listen":":17608","maxResultLimit":100,"metricsPort":":17609","mime":{"defaultContentType":"application/data","enabled":true,"mimeTypesFile":""},"readHeaderTimeout":"2s","readTimeout":"15s","redirects":{"code":0,"enabled":true,"redirects":{}},"secure":{"contentsecuritypolicy":"default-src 'self'","contenttypenosniff":"nosniff","cspreportonly":false,"enabled":true,"hstsmaxage":31536000,"hstspreloadenabled":false,"referrerpolicy":"same-origin","xframeoptions":"SAMEORIGIN","xssprotection":"1; mode=block"},"shutdownGracePeriod":"10s","tls":{"autoCert":false,"certFile":"server.crt","certKey":"server.key","config":"<nil>","enabled":false},"writeTimeout":"15s"}` | Server contains the echo server settings |
| server.dev | bool | `false` | Dev enables echo's dev mode options |
| server.listen | string | `":17608"` | Listen sets the listen address to serve the echo server on |
| server.metricsPort | string | `":17609"` | MetricsPort sets the port for the metrics endpoint |
| server.shutdownGracePeriod | string | `"10s"` | ShutdownGracePeriod sets the grace period for in flight requests before shutting down |
| server.readTimeout | string | `"15s"` | ReadTimeout sets the maximum duration for reading the entire request including the body |
| server.writeTimeout | string | `"15s"` | WriteTimeout sets the maximum duration before timing out writes of the response |
| server.idleTimeout | string | `"30s"` | IdleTimeout sets the maximum amount of time to wait for the next request when keep-alives are enabled |
| server.readHeaderTimeout | string | `"2s"` | ReadHeaderTimeout sets the amount of time allowed to read request headers |
| server.tls | object | `{"autoCert":false,"certFile":"server.crt","certKey":"server.key","config":"<nil>","enabled":false}` | TLS contains the tls configuration settings |
| server.tls.enabled | bool | `false` | Enabled turns on TLS settings for the server |
| server.tls.certFile | string | `"server.crt"` | CertFile location for the TLS server |
| server.tls.certKey | string | `"server.key"` | CertKey file location for the TLS server |
| server.tls.autoCert | bool | `false` | AutoCert generates the cert with letsencrypt, this does not work on localhost |
| server.cors | object | `{"allowOrigins":[],"cookieInsecure":false,"enabled":true,"prefixes":{}}` | CORS contains settings to allow cross origin settings and insecure cookies |
| server.cors.enabled | bool | `true` | Enable or disable the CORS middleware |
| server.cors.prefixes | object | `{}` | Prefixes is a map of prefixes to allowed origins |
| server.cors.allowOrigins | list | `[]` | AllowOrigins is a list of allowed origins |
| server.cors.cookieInsecure | bool | `false` | CookieInsecure sets the cookie to be insecure |
| server.secure | object | `{"contentsecuritypolicy":"default-src 'self'","contenttypenosniff":"nosniff","cspreportonly":false,"enabled":true,"hstsmaxage":31536000,"hstspreloadenabled":false,"referrerpolicy":"same-origin","xframeoptions":"SAMEORIGIN","xssprotection":"1; mode=block"}` | Secure contains settings for the secure middleware |
| server.secure.enabled | bool | `true` | Enabled indicates if the secure middleware should be enabled |
| server.secure.xssprotection | string | `"1; mode=block"` | XSSProtection is the value to set the X-XSS-Protection header to - default is 1; mode=block |
| server.secure.contenttypenosniff | string | `"nosniff"` | ContentTypeNosniff is the value to set the X-Content-Type-Options header to - default is nosniff |
| server.secure.xframeoptions | string | `"SAMEORIGIN"` | XFrameOptions is the value to set the X-Frame-Options header to - default is SAMEORIGIN |
| server.secure.hstspreloadenabled | bool | `false` | HSTSPreloadEnabled is a boolean to enable HSTS preloading - default is false |
| server.secure.hstsmaxage | int | `31536000` | HSTSMaxAge is the max age to set the HSTS header to - default is 31536000 |
| server.secure.contentsecuritypolicy | string | `"default-src 'self'"` | ContentSecurityPolicy is the value to set the Content-Security-Policy header to - default is default-src 'self' |
| server.secure.referrerpolicy | string | `"same-origin"` | ReferrerPolicy is the value to set the Referrer-Policy header to - default is same-origin |
| server.secure.cspreportonly | bool | `false` | CSPReportOnly is a boolean to enable the Content-Security-Policy-Report-Only header - default is false |
| server.redirects | object | `{"code":0,"enabled":true,"redirects":{}}` | Redirect contains settings for the redirect middleware |
| server.redirects.enabled | bool | `true` | Enabled indicates if the redirect middleware should be enabled |
| server.redirects.redirects | object | `{}` | Redirects is a map of paths to redirect to |
| server.redirects.code | int | `0` | Code is the HTTP status code to use for the redirect |
| server.cacheControl | object | `{"enabled":true,"etagHeaders":[],"noCacheHeaders":{}}` | CacheControl contains settings for the cache control middleware |
| server.cacheControl.noCacheHeaders | object | `{}` | noCacheHeaders is the header <-> match map pair to match in http for entity headers to remove |
| server.cacheControl.etagHeaders | list | `[]` | etagHeaders is the string of entity headers to remove |
| server.mime | object | `{"defaultContentType":"application/data","enabled":true,"mimeTypesFile":""}` | Mime contains settings for the mime middleware |
| server.mime.enabled | bool | `true` | Enabled indicates if the mime middleware should be enabled |
| server.mime.mimeTypesFile | string | `""` | MimeTypesFile is the file to load mime types from |
| server.mime.defaultContentType | string | `"application/data"` | DefaultContentType is the default content type to set if no mime type is found |
| server.graphPool | object | `{"maxWorkers":100}` | GraphPool contains settings for the goroutine pool used by the graph resolvers |
| server.graphPool.maxWorkers | int | `100` | MaxWorkers is the maximum number of workers in the pool |
| server.enableGraphExtensions | bool | `true` | EnableGraphExtensions enables the graph extensions for the graph resolvers |
| server.complexityLimit | int | `100` | ComplexityLimit sets the maximum complexity allowed for a query |
| server.maxResultLimit | int | `100` | MaxResultLimit sets the maximum number of results allowed for a query |
| server.csrfProtection | object | `{"cookie":"ol.csrf-token","cookieDomain":"","cookieHttpOnly":false,"cookiePath":"/","enabled":false,"header":"X-CSRF-Token","sameSite":"Lax","secure":true}` | CSRFProtection enables CSRF protection for the server |
| server.csrfProtection.enabled | bool | `false` | Enabled indicates whether CSRF protection is enabled. |
| server.csrfProtection.header | string | `"X-CSRF-Token"` | Header specifies the header name to look for the CSRF token. |
| server.csrfProtection.cookie | string | `"ol.csrf-token"` | Cookie specifies the cookie name used to store the CSRF token. |
| server.csrfProtection.secure | bool | `true` | Secure sets the Secure flag on the CSRF cookie. |
| server.csrfProtection.sameSite | string | `"Lax"` | SameSite configures the SameSite attribute on the CSRF cookie. Valid values are "Lax", "Strict", "None" and "Default". |
| server.csrfProtection.cookieHttpOnly | bool | `false` | CookieHTTPOnly indicates whether the CSRF cookie is HTTP only. |
| server.csrfProtection.cookieDomain | string | `""` | CookieDomain specifies the domain for the CSRF cookie, default to no domain |
| server.csrfProtection.cookiePath | string | `"/"` | CookiePath specifies the path for the CSRF cookie, default to "/" |
| server.defaultTrustCenterDomain | string | `""` | DefaultTrustCenterDomain is the default domain to use for the trust center if no custom domain is set |
| entConfig | object | `{"entityTypes":[],"maxPoolSize":100,"summarizer":{"llm":{"anthropic":{"baseURL":"","betaHeader":"","legacyTextCompletion":false},"cloudflare":{"accountID":"","serverURL":""},"gemini":{"credentialsPath":"","maxTokens":0},"huggingFace":{"url":""},"mistral":{"url":""},"ollama":{"model":"","url":""},"openai":{"organizationID":"","url":""},"provider":null},"maximumSentences":60,"type":"lexrank"}}` | EntConfig contains the ent configuration used by the ent middleware |
| entConfig.entityTypes | list | `[]` | EntityTypes is the list of entity types to create by default for the organization |
| entConfig.summarizer | object | `{"llm":{"anthropic":{"baseURL":"","betaHeader":"","legacyTextCompletion":false},"cloudflare":{"accountID":"","serverURL":""},"gemini":{"credentialsPath":"","maxTokens":0},"huggingFace":{"url":""},"mistral":{"url":""},"ollama":{"model":"","url":""},"openai":{"organizationID":"","url":""},"provider":null},"maximumSentences":60,"type":"lexrank"}` | Summarizer contains configuration for text summarization |
| entConfig.summarizer.type | string | `"lexrank"` | Type specifies the summarization algorithm to use |
| entConfig.summarizer.llm | object | `{"anthropic":{"baseURL":"","betaHeader":"","legacyTextCompletion":false},"cloudflare":{"accountID":"","serverURL":""},"gemini":{"credentialsPath":"","maxTokens":0},"huggingFace":{"url":""},"mistral":{"url":""},"ollama":{"model":"","url":""},"openai":{"organizationID":"","url":""},"provider":null}` | LLM contains configuration for large language model based summarization |
| entConfig.summarizer.llm.provider | string | `nil` | Provider specifies which LLM service to use |
| entConfig.summarizer.llm.anthropic | object | `{"baseURL":"","betaHeader":"","legacyTextCompletion":false}` | Anthropic contains configuration for Anthropic's API |
| entConfig.summarizer.llm.anthropic.betaHeader | string | `""` | BetaHeader specifies the beta API features to enable |
| entConfig.summarizer.llm.anthropic.legacyTextCompletion | bool | `false` | LegacyTextCompletion enables legacy text completion API |
| entConfig.summarizer.llm.anthropic.baseURL | string | `""` | BaseURL specifies the API endpoint |
| entConfig.summarizer.llm.mistral | object | `{"url":""}` | Mistral contains configuration for Mistral's API |
| entConfig.summarizer.llm.mistral.url | string | `""` | URL specifies the API endpoint |
| entConfig.summarizer.llm.gemini | object | `{"credentialsPath":"","maxTokens":0}` | Gemini contains configuration for Google's Gemini API |
| entConfig.summarizer.llm.gemini.credentialsPath | string | `""` | CredentialsPath is the path to Google Cloud credentials file |
| entConfig.summarizer.llm.gemini.maxTokens | int | `0` | MaxTokens specifies the maximum tokens for response |
| entConfig.summarizer.llm.huggingFace | object | `{"url":""}` | HuggingFace contains configuration for HuggingFace's API |
| entConfig.summarizer.llm.huggingFace.url | string | `""` | URL specifies the API endpoint |
| entConfig.summarizer.llm.ollama | object | `{"model":"","url":""}` | Ollama contains configuration for Ollama's API |
| entConfig.summarizer.llm.ollama.model | string | `""` | Model specifies the model to use |
| entConfig.summarizer.llm.ollama.url | string | `""` | URL specifies the API endpoint |
| entConfig.summarizer.llm.cloudflare | object | `{"accountID":"","serverURL":""}` | Cloudflare contains configuration for Cloudflare's API |
| entConfig.summarizer.llm.cloudflare.accountID | string | `""` | AccountID specifies the Cloudflare account ID |
| entConfig.summarizer.llm.cloudflare.serverURL | string | `""` | ServerURL specifies the API endpoint |
| entConfig.summarizer.llm.openai | object | `{"organizationID":"","url":""}` | OpenAI contains configuration for OpenAI's API |
| entConfig.summarizer.llm.openai.url | string | `""` | URL specifies the API endpoint |
| entConfig.summarizer.llm.openai.organizationID | string | `""` | OrganizationID specifies the OpenAI organization ID |
| entConfig.summarizer.maximumSentences | int | `60` | MaximumSentences specifies the maximum number of sentences in the summary |
| entConfig.maxPoolSize | int | `100` | MaxPoolSize is the max pond pool workers that can be used by the ent client |
| auth | object | `{"enabled":true,"providers":{"github":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/github/callback","scopes":[]},"google":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/google/callback","scopes":[]},"redirectUrl":"http://localhost:3001/api/auth/callback/theopenlane","webauthn":{"debug":false,"displayName":"","enabled":true,"enforceTimeout":true,"maxDevices":10,"relyingPartyId":"localhost","requestOrigins":["http://localhost:3001"],"timeout":"1m0s"}},"supportedProviders":[],"token":{"accessDuration":"1h0m0s","audience":"https://theopenlane.io","generateKeys":true,"issuer":"https://auth.theopenlane.io","jwksEndpoint":"https://api.theopenlane.io/.well-known/jwks.json","keys":{},"kid":"","refreshAudience":"","refreshDuration":"2h0m0s","refreshOverlap":"-15m0s"}}` | Auth contains the authentication token settings and provider(s) |
| auth.enabled | bool | `true` | Enabled authentication on the server, not recommended to disable |
| auth.token | object | `{"accessDuration":"1h0m0s","audience":"https://theopenlane.io","generateKeys":true,"issuer":"https://auth.theopenlane.io","jwksEndpoint":"https://api.theopenlane.io/.well-known/jwks.json","keys":{},"kid":"","refreshAudience":"","refreshDuration":"2h0m0s","refreshOverlap":"-15m0s"}` | Token contains the token config settings for the issued tokens |
| auth.supportedProviders | list | `[]` | SupportedProviders are the supported oauth providers that have been configured |
| auth.providers | object | `{"github":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/github/callback","scopes":[]},"google":{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/google/callback","scopes":[]},"redirectUrl":"http://localhost:3001/api/auth/callback/theopenlane","webauthn":{"debug":false,"displayName":"","enabled":true,"enforceTimeout":true,"maxDevices":10,"relyingPartyId":"localhost","requestOrigins":["http://localhost:3001"],"timeout":"1m0s"}}` | Providers contains supported oauth2 providers configuration |
| auth.providers.redirectUrl | string | `"http://localhost:3001/api/auth/callback/theopenlane"` | RedirectURL is the URL that the OAuth2 client will redirect to after authentication is complete |
| auth.providers.github | object | `{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/github/callback","scopes":[]}` | Github contains the configuration settings for the Github Oauth Provider |
| auth.providers.google | object | `{"clientEndpoint":"http://localhost:17608","clientId":"","clientSecret":"","redirectUrl":"/v1/google/callback","scopes":[]}` | Google contains the configuration settings for the Google Oauth Provider |
| auth.providers.webauthn | object | `{"debug":false,"displayName":"","enabled":true,"enforceTimeout":true,"maxDevices":10,"relyingPartyId":"localhost","requestOrigins":["http://localhost:3001"],"timeout":"1m0s"}` | Webauthn contains the configuration settings for the Webauthn Oauth Provider |
| authz | object | `{"createNewModel":false,"credentials":{"apiToken":"","audience":"","clientId":"","clientSecret":"","issuer":"","scopes":""},"enabled":true,"hostUrl":"https://authz.theopenlane.io","ignoreDuplicateKeyError":true,"modelFile":"fga/model/model.fga","modelId":"","storeId":"","storeName":"openlane"}` | Authz contains the authorization settings for fine grained access control |
| authz.enabled | bool | `true` | enables authorization checks with openFGA |
| authz.storeName | string | `"openlane"` | name of openFGA store |
| authz.hostUrl | string | `"https://authz.theopenlane.io"` | host url with scheme of the openFGA API |
| authz.storeId | string | `""` | id of openFGA store |
| authz.modelId | string | `""` | id of openFGA model |
| authz.createNewModel | bool | `false` | force create a new model |
| authz.modelFile | string | `"fga/model/model.fga"` | path to the fga model file |
| authz.credentials | object | `{"apiToken":"","audience":"","clientId":"","clientSecret":"","issuer":"","scopes":""}` | credentials for the openFGA client |
| authz.credentials.apiToken | string | `""` | api token for the openFGA client |
| authz.credentials.clientId | string | `""` | client id for the openFGA client |
| authz.credentials.clientSecret | string | `""` | client secret for the openFGA client |
| authz.credentials.audience | string | `""` | audience for the openFGA client |
| authz.credentials.issuer | string | `""` | issuer for the openFGA client |
| authz.credentials.scopes | string | `""` | scopes for the openFGA client |
| authz.ignoreDuplicateKeyError | bool | `true` | ignore duplicate key error |
| db | object | `{"cacheTTL":"1s","databaseName":"openlane","debug":false,"driverName":"pgx","enableHistory":false,"maxConnections":0,"maxIdleConnections":0,"migrationProvider":"atlas","multiWrite":false,"primaryDbSource":"file:openlane.db","runMigrations":true,"secondaryDbSource":"file:backup.db"}` | DB contains the database configuration for the ent client |
| db.debug | bool | `false` | debug enables printing the debug database logs |
| db.databaseName | string | `"openlane"` | the name of the database to use with otel tracing |
| db.driverName | string | `"pgx"` | sql driver name |
| db.multiWrite | bool | `false` | enables writing to two databases simultaneously |
| db.primaryDbSource | string | `"file:openlane.db"` | dsn of the primary database |
| db.secondaryDbSource | string | `"file:backup.db"` | dsn of the secondary database if multi-write is enabled |
| db.cacheTTL | string | `"1s"` | cache results for subsequent requests |
| db.runMigrations | bool | `true` | run migrations on startup |
| db.migrationProvider | string | `"atlas"` | migration provider to use for running migrations |
| db.enableHistory | bool | `false` | enable history data to be logged to the database |
| db.maxConnections | int | `0` | maximum number of connections to the database |
| db.maxIdleConnections | int | `0` | maximum number of idle connections to the database |
| jobQueue | object | `{"connectionURI":"postgres://postgres:password@0.0.0.0:5432/jobs?sslmode=disable","riverConf":null,"runMigrations":false}` | JobQueue contains the configuration for the job queue (river) client |
| redis | object | `{"address":"localhost:6379","db":0,"dialTimeout":"5s","enabled":true,"maxActiveConns":0,"maxIdleConns":0,"maxRetries":3,"minIdleConns":0,"name":"","password":"","readTimeout":"0s","username":"","writeTimeout":"0s"}` | Redis contains the redis configuration for the key-value store |
| tracer | object | `{"enabled":false,"environment":"development","otlp":{"certificate":"","compression":"","endpoint":"localhost:4317","headers":[],"insecure":true,"timeout":"10s"},"provider":"stdout","stdout":{"disableTimestamp":false,"pretty":true}}` | Tracer contains the tracing config for opentelemetry |
| email | object | `{"companyAddress":"","companyName":"","corporation":"","fromEmail":"","logoURL":"","supportEmail":"","templatesPath":"","urls":{"docs":"","invite":"","product":"","reset":"","root":"","verify":"","verifyBilling":"","verifySubscriber":""},"year":0}` | Email contains email sending configuration for the server |
| sessions | object | `{"domain":"","encryptionKey":"encryptionsecret","httpOnly":true,"maxAge":3600,"sameSite":"Strict","secure":true,"signingKey":"my-signing-secret"}` | Sessions config for user sessions and cookies |
| totp | object | `{"codeLength":6,"enabled":true,"issuer":"","recoveryCodeCount":16,"recoveryCodeLength":8,"redis":true,"secret":""}` | TOTP contains the configuration for the TOTP provider |
| ratelimit | object | `{"burst":30,"enabled":false,"expires":"10m0s","limit":10}` | Ratelimit contains the configuration for the rate limiter |
| objectStorage | object | `{"defaultBucket":"file_uploads","enabled":true,"keys":["uploadFile"],"localURL":"http://localhost:17608/files/","maxMemoryMB":0,"maxSizeMB":0,"provider":"","region":""}` | ObjectStorage contains the configuration for the object storage backend |
| objectStorage.enabled | bool | `true` | Enabled indicates if the store is enabled |
| objectStorage.provider | string | `""` | Provider is the name of the provider, eg. disk, s3, will default to disk if nothing is set |
| objectStorage.region | string | `""` | Region is the region for the storage provider |
| objectStorage.defaultBucket | string | `"file_uploads"` | DefaultBucket is the default bucket name for the storage provider, if not set, it will use the default this is the local path for disk storage or the bucket name for S3 |
| objectStorage.localURL | string | `"http://localhost:17608/files/"` | LocalURL is the URL to use for the "presigned" URL for the file when using local storage e.g for local development, this can be http://localhost:17608/files/ |
| objectStorage.keys | list | `["uploadFile"]` | Keys is a list of keys to look for in the multipart form on the REST request if the keys are not found, the request upload will be skipped this is not used when uploading files with gqlgen and the graphql handler |
| objectStorage.maxSizeMB | int | `0` | MaxUploadSizeMB is the maximum size of file uploads to accept in megabytes |
| objectStorage.maxMemoryMB | int | `0` | MaxUploadMemoryMB is the maximum memory in megabytes to use when parsing a multipart form |
| subscription | object | `{"enabled":false,"personalOrgSubscriptionPriceID":"price_1QycPyBvxky1R7Svz0gOWnNh","publicStripeKey":"","stripeBillingPortalSuccessURL":"https://console.openlane.com/billing","stripeCancellationReturnURL":"https://console.theopenlane.io/organization-settings/billing/subscription_canceled","stripeWebhookEvents":[],"stripeWebhookURL":"https://api.openlane.com/v1/stripe/webhook","trialSubscriptionPriceID":"price_1QKLyeBvxky1R7SvaZYGWyQb"}` | Entitlements contains the configuration for the entitlements service |
| keywatcher | object | `{"enabled":false,"externalSecretsIntegration":false,"keyDir":"./keys"}` | Keywatcher contains the configuration for the key watcher that manages JWT signing keys |
| keywatcher.enabled | bool | `false` | Enabled indicates whether the key watcher is enabled |
| keywatcher.keyDir | string | `"./keys"` | KeyDir is the path to the directory containing PEM keys for JWT signing |
| keywatcher.externalSecretsIntegration | bool | `false` | ExternalSecretsIntegration enables integration with external secret management systems (specifically GCP secret manager today) |
| slack | object | `{"newSubscriberMessageFile":"","newUserMessageFile":""}` | Slack contains settings for Slack notifications |
| slack.newSubscriberMessageFile | string | `""` | NewSubscriberMessageFile is the path to the template used for new subscriber notifications |
| slack.newUserMessageFile | string | `""` | NewUserMessageFile is the path to the template used for new user notifications |
| externalSecrets | object | `{"enabled":true,"secrets":{"core-entconfig-summarizer-llm-gemini-credentialsjson":{"enabled":true,"remoteKey":"core-entconfig-summarizer-llm-gemini-credentialsjson","secretKey":"CORE_ENTCONFIG_SUMMARIZER_LLM_GEMINI_CREDENTIALSJSON"},"core-keywatcher-secretmanager":{"enabled":true,"remoteKey":"core-keywatcher-secretmanager","secretKey":"CORE_KEYWATCHER_SECRETMANAGER"},"core-objectstorage-accesskey":{"enabled":true,"remoteKey":"core-objectstorage-accesskey","secretKey":"CORE_OBJECTSTORAGE_ACCESSKEY"},"core-objectstorage-credentialsjson":{"enabled":true,"remoteKey":"core-objectstorage-credentialsjson","secretKey":"CORE_OBJECTSTORAGE_CREDENTIALSJSON"},"core-objectstorage-secretkey":{"enabled":true,"remoteKey":"core-objectstorage-secretkey","secretKey":"CORE_OBJECTSTORAGE_SECRETKEY"},"core-server-secretmanager":{"enabled":true,"remoteKey":"core-server-secretmanager","secretKey":"CORE_SERVER_SECRETMANAGER"},"core-slack-webhookurl":{"enabled":true,"remoteKey":"core-slack-webhookurl","secretKey":"CORE_SLACK_WEBHOOKURL"},"core-subscription-privatestripekey":{"enabled":true,"remoteKey":"core-subscription-privatestripekey","secretKey":"CORE_SUBSCRIPTION_PRIVATESTRIPEKEY"},"core-subscription-stripewebhooksecret":{"enabled":true,"remoteKey":"core-subscription-stripewebhooksecret","secretKey":"CORE_SUBSCRIPTION_STRIPEWEBHOOKSECRET"}}}` | External Secrets configuration |
