...
| openlane.coreConfiguration.server.secure.hstsmaxage | string | `"31536000"` | HSTSMaxAge is the max age to set the HSTS header to - default is 31536000 |
...
| riverboat.workers.emailWorker.testDir | string | `"fixtures/email"` |  |
...
| riverboat.workers.deleteExportContentWorker.interval | string | `"5m"` |  |
| riverboat.workers.deleteExportContentWorker.cutoffDuration | string | `"24h"` |  |
| riverboat.workers.deleteExportContentWorker.openlaneAPIHost | string | `nil` |  |
| riverboat.workers.exportContentWorker.enabled | bool | `false` |  |
| riverboat.workers.exportContentWorker.openlaneAPIHost | string | `nil` |  |
| riverboat.workers.customDomainWorker.enabled | bool | `false` |  |
| riverboat.workers.customDomainWorker.openlaneAPIHost | string | `nil` |  |
| riverboat.workers.databaseWorker.enabled | bool | `false` |  |
| riverboat.workers.databaseWorker.baseUrl | string | `nil` |  |
