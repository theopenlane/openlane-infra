...
```bash
docker run --rm -it -w /charts -v $(pwd)/../../:/charts quay.io/helmpack/chart-testing:v3.12.0 ct lint --charts /charts/charts/trustcenter --config /charts/charts/trustcenter/ct.yaml
```
